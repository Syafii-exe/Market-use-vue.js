...
import FooterMarket from '@/components/FooterMarket.vue'
import carousel from 'vue-owl-carousel'
import ReletedProduct from '@/components/ReletedProduct.vue'

export default {
  name: 'Product',
  components: {
    HeaderMarket, FooterMarket, carousel, ReletedProduct
  },
  data(){
      return{
          gambar_default: "img/mickey1.jpg",
          thumbs: [
              "img/mickey1.jpg", "img/mickey2.jpg", "img/mickey3.jpg", "img/mickey4.jpg"
          ]
      }
  },
  methods: {
