                                    ...
                                    <tbody>
                                        ...
                                        <tr v-for="keranjang in keranjangUser" :key="keranjang.id">
                                            <td class="cart-pic first-row">
                                                <img class="img-photo" :src="keranjang.photo" />
                                            </td>
                        ...
                        <div class="col-lg-12">
                            <div class="proceed-checkout text-left">
                                <ul>
                                    ...
                                    <li class="subtotal mt-3">Pajak 10% <span>${{ pajak }}.00</span></li>
                                    <li class="subtotal mt-3">Total Biaya <span>${{ totalBayar}}.00</span></li>
                                    <li class="subtotal mt-3">Bank Transfer <span>Mandiri</span></li>
                                    <li class="subtotal mt-3">No. Rekening <span>2208 1996 1403</span></li>
                                    <li class="subtotal mt-3">Nama Penerima <span>Market</span></li>
                                </ul>
